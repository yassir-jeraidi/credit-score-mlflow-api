...
class CreditApplication(BaseModel):
    ...
    age: int = Field(
        ...
        ge=18,
        le=100,
        description="Age of the applicant (18-100 years)",
        examples=[35]
    )
    income: float = Field(
        ...,
    ...
    num_credit_lines: int = Field(
        ...
        ge=0,
        le=50,
        description="Number of credit lines/accounts",
        examples=[5]
    )
...
class PredictionResponse(BaseModel):
    ...
    risk_score: float = Field(
        ...
        ge=0,
        le=1,
        description="Risk score (probability of rejection)"
    )
    ...
    rejection_probability: float = Field(
        ...
        ge=0,
        le=1,
        description="Probability of rejection"
    )
...
class BatchPredictionRequest(BaseModel):
    ...
    applications: List[CreditApplication] = Field(
        ...
        min_length=1,
        max_length=100,
        description="List of credit applications (max 100)"
    )
...
class ModelInfoResponse(BaseModel):
    ...
    model_stage: str = Field(
        ...,
        description="Model stage (Production, Staging, etc.)"
    )
    model_version: Optional[str] = Field(
        None,
